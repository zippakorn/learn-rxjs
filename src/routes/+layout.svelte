...
<div class="flex h-screen">
	<aside class="w-64 bg-gray-900 p-4 text-gray-200 shadow-lg">
		<h1 class="mb-4 text-xl font-bold text-white">Learn RxJS</h1>
		<nav>
			<ul class="space-y-2">
				...
				<li><a href="/combine" class="text-gray-400 hover:text-white">Combine Observable</a></li>
				<li><a href="/car" class="text-gray-400 hover:text-white">Car Factory Problem</a></li>
			</ul>
		</nav>
	</aside>
	<main class="flex-1 overflow-y-auto bg-gray-800 p-4 text-gray-100">
		{@render children?.()}
	</main>
</div>
